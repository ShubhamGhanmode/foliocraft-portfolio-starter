            ...
            <Container className="relative z-10">
                ...
                <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-16 items-start">
                    {image && (
                        ...
                        >
                            {/* Decorative frame */}
                            <div className="absolute -inset-6 rounded-[--radius-lg] border border-[--color-border] opacity-50" />
                            <div className="absolute -inset-3 rounded-[--radius-lg] bg-gradient-to-br from-[--color-primary] to-[--color-secondary] opacity-10" />
                            ...
                            {/* Floating badge */}
                            <motion.div
                                className="absolute -bottom-4 -right-4 px-5 py-3 rounded-[--radius-md] bg-gradient-to-r from-[--color-primary] to-[--color-secondary] text-[--color-background] text-sm font-semibold shadow-[var(--shadow-lift)]"
                                animate={{ y: [0, -5, 0] }}
