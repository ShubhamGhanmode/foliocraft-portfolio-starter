                        ...
                        <motion.div key={index} variants={itemVariants}>
                            ...
                            >
                                ...
                                <div className="relative aspect-video overflow-hidden">
                                    ...
                                    {/* Featured badge */}
                                    {project.featured && (
                                        <div className="absolute top-4 left-4 rounded-full bg-gradient-to-r from-[--color-primary] to-[--color-secondary] px-4 py-1.5 text-xs uppercase tracking-[0.15em] text-[--color-background] font-semibold shadow-[var(--shadow-lift)]">
                                            ✨ Featured
                                        </div>
                                    )}
