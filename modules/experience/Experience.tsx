        ...
        <Section sectionId={id} className={cn('pt-24', className)}>
            <Container size="narrow">
                ...
                <div className="relative">
                    ...
                    <div className="absolute left-4 top-0 h-full w-0.5 bg-gradient-to-b from-[--color-primary] via-[--color-secondary] to-[--color-border] rounded-full" />
                    ...
                    <div className="space-y-10">
                        {items.map((experience, index) => (
                            ...
                            >
                                ...
                                <div className="absolute left-0 top-6 w-9 h-9 rounded-full bg-gradient-to-br from-[--color-primary] to-[--color-secondary] flex items-center justify-center shadow-[var(--shadow-lift)]">
                                    <Briefcase className="w-4 h-4 text-[--color-background]" />
                                </div>
                                ...
                                <Card variant="glass" hover="glow" className="space-y-5">
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                        ...
                                        <span className="inline-flex items-center px-3 py-1.5 rounded-full bg-[--color-accent] border border-[--color-border] text-xs uppercase tracking-[0.15em] text-[--color-muted] font-medium">
