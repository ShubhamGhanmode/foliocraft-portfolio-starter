        ...
        <main className="min-h-screen pt-24 pb-16">
            <Container size="wide">
                <motion.div
                    ...
                    className="relative overflow-hidden rounded-[--radius-lg] border border-[--color-border] bg-[--color-accent] p-8 md:p-10 mb-12"
                >
                    ...
                    <div className="relative grid gap-10 lg:grid-cols-[1.15fr_0.85fr] items-end">
                        ...
                        <div className="grid grid-cols-3 gap-3 sm:gap-4">
                            {stats.map((stat) => (
                                <div
                                    key={stat.label}
                                    className="rounded-[--radius-md] border border-[--color-border] bg-[--color-background] p-4 text-center shadow-[var(--shadow-soft)]"
                                >
                                    <p className="text-xs uppercase tracking-[0.2em] text-[--color-muted]">
                                        {stat.label}
                                    </p>
                                    <p className="text-2xl font-semibold text-[--color-foreground] mt-2">
                                        {stat.value}
                                    </p>
                                </div>
                            ))}
                ...
                >
                    <aside className="space-y-6 lg:sticky lg:top-28">
                        <div className="rounded-[--radius-lg] border border-[--color-border] bg-[--color-background] p-6 shadow-[var(--shadow-soft)]">
